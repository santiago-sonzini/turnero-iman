...
export function LandingPage() {
  ...
  return <main className="landing">
    ...
    <section className="landing-section" id="precio"><div className="landing-wrap landing-price-wrap"><p className="landing-kicker centered">PRECIOS EN PESOS</p><h2 className="centered">Un precio que se paga solo</h2><div className="landing-prices"><PriceCard name="Turnos" price="15.000" copy="Un corte recuperado por semana y ya está pago." items={["Turnos ilimitados","Página de reservas con tu marca","Clientes que ya están para volver","Promos e incentivos","WhatsApp listo para enviar"]}/><PriceCard featured name="Turnos Auto" price="30.000" copy="Tu equipo completo y tu página con tu estilo." items={["Todo el plan Turnos","Hasta 3 profesionales, cada uno con su agenda","El cliente elige con quién se atiende","Link de reserva directo por profesional","Temas visuales para tu página pública"]}/></div><div className="landing-guarantee"><span>🤝</span><div><b>7 días para probarlo en serio.</b><p>Sin tarjeta. Tus datos son tuyos y cancelás cuando quieras.</p></div></div></div></section>
    ...
    <section className="landing-section alternate"><div className="landing-wrap landing-faq"><p className="landing-kicker">SIN LETRA CHICA</p><h2>Preguntas de barbero</h2>{[
      ["¿Cuánto sale?","Turnos cuesta $ 15.000 por mes y Turnos Auto $ 30.000. En pesos, sin costo por turno ni sorpresas en dólares."],
