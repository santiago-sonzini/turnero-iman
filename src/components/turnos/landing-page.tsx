...
export function LandingPage() {
  ...
  return <main className="landing">
    ...
    <section className="landing-section alternate"><div className="landing-wrap landing-faq"><p className="landing-kicker">SIN LETRA CHICA</p><h2>Preguntas de barbero</h2>{[
      ...
      ["¿Cómo funciona WhatsApp?","En Turnos abrís mensajes listos mediante wa.me. Turnos Auto agrega automatización opcional desde tu número, con consentimiento y fallback."],
