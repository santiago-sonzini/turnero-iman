...
import { OrdersTable } from "./invoices-table";
...
export default function InvoicesPageTable({ id }: { id?: string}) {
  ...
  return (
    <div className="space-y-6 p-8 mt-10 h-screen overflow-scroll">
      <div className="flex flex-row items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Facturas</h1>
          <p className="text-sm text-gray-500">
            Administra tus facturas con filtros, estados y detalles de cliente.
          </p>
        </div>
