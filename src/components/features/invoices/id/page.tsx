...
const InvoiceDetailPage = ({ order: OrderProp }: { order: OrderWithDetails }) => {
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-6 rounded-sm bg-white p-6 shadow dark:bg-neutral-900">
          <div className="mb-4 flex items-start justify-between">
            ...
            <button
              onClick={generatePDF}
              className="flex items-center gap-2 rounded-sm bg-[#221d16] px-4 py-2 font-semibold text-white shadow-sm transition-colors hover:bg-[#221d16]"
            >
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {order.products.map((item, index) => (
                  <tr
                    key={item.id}
                    className={`border-b dark:border-neutral-800 ${index % 2 === 0
